...
# Version storage location (in project root)
PROJECT_ROOT = Path(__file__).parent.parent.parent
VERSIONS_FILE = PROJECT_ROOT / "versions.json"
BACKUP_DIR = PROJECT_ROOT / "version_backups"

# Files to track for versions (new structure)
TRACKED_FILES = [
    "core/web/index.html",
    "core/web/admin.html",
    "core/server/main.py",
    "core/server/chat.py",
    "core/server/secrets.py",
    "core/server/memories.py",
    "core/server/config.py",
    "core/server/plugin_loader.py",
    "core/server/extension_request.py",
